...
$message = Session::t('We are unable to process your request at this time.<br/>Our engineers have been notified of this problem and will work to resolve it.');
        ...
        <div class="content-wrapper content-wrapper-login">
            <div class="container">
        		<div class="row row-xs-offset-1">
            		...
            		<h1 style="font-size: 12em;">520</h1>
            		<h1><?php echo Session::t('An unknown error occurred!'); ?>'</h1>
