...
if ($method && $apiToken) {
    switch ($method) {
        case "detectLanguage":
            $url = "https://www.mt-hub.eu/api/detectlanguage";
            $data = [
                'segments[0]' => $segments,
                'token' => $apiToken
            ];
            break;
        case "detectDomain":
            $url = "https://www.mt-hub.eu/api/detectdomain";
            $data = [
                'segments[0]' => $segments,
                'token' => $apiToken,
                'source' => $source
            ...
            break;
        case "translate":
            $url = "https://www.mt-hub.eu/api/translate";
            $data = [
                'segments[0]' => $segments,
                'token' => $apiToken,
                'source' => $source,
            ...
            break;
        case "aTranslate":
            $url = "https://www.mt-hub.eu/api/atranslate";
            $data = [
                'segments[0]' => $segments,
                'token' => $apiToken,
                'source' => $source,
        ...
        case "aRetrieveTranslation":
            $url = "https://www.mt-hub.eu/api/aretrievetranslation/" . $apiToken . '/' . $segments;
            $data = null;
            break;
    }
