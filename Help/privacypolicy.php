<?php include_once '../functions.php'; ?>
    ...
    <div class="modal-help">
        <div class="font-small">
            <p>Date of last revision: October 1st, 2018</p>
            <p>
            ...
            <p>
                <dt class="text-light-blue">How We Collect and Use Your Personally
            ...
            <p>We also use this information to provide you with customer support and to communicate regularly with you.
                While providing you with customer support we
                may also gather additional information from you. From time to time we will also offer you the
                opportunity to receive information about products or services offered by our third-party partners. We
                will not share your personally identifying information with these third parties for their marketing
                purposes, unless we have your permission to do so. </p>
            ...
            <p>
                <dt class="text-light-blue">Other Information We Collect</dt>
            </p>
            <p class="text-light-blue">Consumer Opinion Surveys</p>
            <p>We occasionally conduct online consumer surveys to learn about your
                views on our products and services. We do not collect personally
                identifying information in these surveys. We use the survey data for
                research and to improve our services.</p>
            <p class="text-light-blue">Cookies</p>
            <p>Cookies are very small text files that are stored on your computer
                when you visit certain web pages. We use cookies on our site to:
            <ul>
                <li>help you navigate our website</li>
                <li>facilitate the sign up and login process for our services</li>
                <li>personalize your experience</li>
                <li>analyze which pages our site visitors visit</li>
                <li>measure advertising and promotional effectiveness</li>
            </ul>
            </p>
            <p class="text-light-blue">Information Automatically Collected By Our
                Site</p>
            <p>As is true of most Web sites, we gather Web server log file information automatically such as your IP
                address, browser type, referring/exit pages, and operating system. We use this information to administer
                our website, understand how visitors navigate through our Site and to enhance your experience while
                using our Site.</p>
            <p>
                <dt class="text-light-blue">How We Share Your Personally Identifying
                    Information
                </dt>
            </p>
            <p>We may provide your personally identifying information to companies that provide services to help us with
                our business activities such as web site analytics or offering customer service. These third parties are
                authorized to use your personally identifying information only as necessary to provide these services to
                us.</p>
            <p>We may also disclose your personally identifying information
            <ul>
            ...
            <p>We will share your personally identifying information with third parties only in the ways that are
                described in this Privacy Statement. We do not otherwise sell your personally identifying information to
                third parties.</p>
            <p>
                <dt class="text-light-blue">Accessing and Updating your Personally
                    Identifying Information
                </dt>
            </p>
            ...
            <p>iADAATPA will make commercially reasonable efforts to provide you reasonable access to any of your
                ...
                that we cannot provide you access to this information, we will explain why we cannot do so. </p>
            <p>
            ...
            <blockquote class="blockquote" style="font-size: 0.9em;">
                <p>Please be aware, however, that no transmission of information via
                    the Internet can be entirely secure. You should, therefore, always
                    use caution when submitting personally identifying information
                    online.</p>
            </blockquote>
            ...
            <p>This Privacy Statement applies to iADAATPA Web services only. Our Site includes links to other Web sites.
                ...
                visit.</p>
            <p>
                <dt class="text-light-blue">Changes to this Privacy Statement</dt>
            </p>
            <p>Please note that this Privacy Statement may change from time to time. If we change this privacy statement
                in ways that affect how we use your personally identifying information, we will advise you of choices
                you may have as a result of those changes. We will also post a notice on our home page that this Privacy
                Statement has changed. </p>
        </div>
    </div>
