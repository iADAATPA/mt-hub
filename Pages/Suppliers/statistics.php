...
$breadCrumb =  [
    'icon' => 'fa-pie-chart',
    'link' => 'Pages/Suppliers/statistics.php',
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var link = 'Pages/Suppliers/Forms/statisticsgeneral.php';
        ...
        $('[href="#monthlyStatistics"]').click(function(e) {
            if ($('[href="#monthlyStatistics"]').closest('li').hasClass("disabled")) {
                ...
                var link = 'Pages/Suppliers/Forms/statisticsmonthly.php';
        ...
        $('[href="#detailedStatistics"]').click(function(e) {
            if ($('[href="#detailedStatistics"]').closest('li').hasClass("disabled")) {
                ...
                var link = 'Datatables/statistics.php?type=<?php echo StatisticsSummary::TYPE_SUPPLIER; ?>';
